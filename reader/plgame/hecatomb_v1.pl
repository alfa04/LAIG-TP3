...
play(pvp):-
    ...
    board(B),printB(B),pvpgame(Player, B, 10,4,3,4,4).
...
pvpgame(_,Board,_,_,_,_,_,_):-            
        game_over(Board).

pvpgame(_,Board,0,_,_,_,_,_):-gameDraw(Board).

pvpgame(P,Board,Turns,Xi,Yi,Xf,Yf,B3):-
    Turns > 0, 
    Turns2 is Turns-1,
    printPlayer(P,h), 
    ...
    replace(B2, Xi, Yi, ' ', B3), printB(B3),changePlayer(P,Novo),!.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pvbgame(_,Board,_,_):-            
        game_over(Board).
